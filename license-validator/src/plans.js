...
export const DEFAULT_PLANS = [
  ...
  // pods. It grants every tab the binary can build, and it is where a new
  // tab lands first, before it is on anything a customer pays for.
  {
    _id: "admin",
    name: "Admin (Internal)",
